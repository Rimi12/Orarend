              ...
              <div className="flex flex-1 min-h-0 overflow-hidden">
                <div className="flex-1 overflow-auto relative">
                  <table className="border-separate border-spacing-0 w-full text-xs" style={{ minWidth: `${100 + locations.length * 95}px` }}>
                    <thead>
                      <tr>
                        <th className="border border-gray-300 dark:border-gray-600 p-2 font-bold text-gray-800 dark:text-gray-200 whitespace-nowrap bg-teal-100 dark:bg-teal-900 text-center"
                            style={{
                              position: 'sticky',
                              top: 0,
                              left: 0,
                        ...
                        {locations.map((loc, lIdx) => (
                          <th key={lIdx}
                              className="border-t border-b border-r border-gray-300 dark:border-gray-600 p-2 font-bold text-teal-900 dark:text-teal-200 text-center whitespace-nowrap bg-teal-50 dark:bg-teal-950"
                              style={{
                                position: 'sticky',
                                top: 0,
                                zIndex: 20,
                      ...
                      {timeSlots.map((ts, tsIdx) => {
                        ...
                        return (
                          <tr key={tsIdx} className={tsIdx % 2 === 0 ? 'bg-white dark:bg-gray-900' : 'bg-gray-50/60 dark:bg-gray-800/40'}>
                            ...
                            <td className="border-l border-b border-r border-gray-300 dark:border-gray-600 p-2 font-bold text-gray-800 dark:text-gray-200 whitespace-nowrap text-center bg-gray-100 dark:bg-gray-800 text-xs"
                                style={{
                                  position: 'sticky',
                                  left: 0,
                                  zIndex: 10,
    ...
    return (
      <div className="mb-8 bg-white dark:bg-gray-900 p-4 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm">
        ...
        <table className="border-separate border-spacing-0 w-full text-xs shadow-sm rounded-lg border border-gray-300 dark:border-gray-700">
          <thead>
            <tr>
              <th className="border border-teal-800 p-2 font-bold w-24 text-center bg-teal-800 text-white"
                  style={{
                    position: 'sticky',
                    top: 0,
                    left: 0,
              ...
              {DAYS_OF_WEEK.map((dayName, dIdx) => {
                ...
                return (
                  <th key={dIdx}
                      className={`border-t border-b border-r border-teal-800 p-2 font-bold text-center ${
          ...
          <tbody>
            {timeSlots.map((ts, tsIdx) => {
              ...
              return (
                <tr key={tsIdx} className={tsIdx % 2 === 0 ? 'bg-white dark:bg-gray-900' : 'bg-gray-50/60 dark:bg-gray-800/40'}>
                  <td className="border-l border-b border-r border-gray-300 dark:border-gray-700 p-2 font-bold text-gray-800 dark:text-gray-200 text-center bg-gray-100 dark:bg-gray-800 whitespace-nowrap w-24 text-xs"
                      style={{
                        position: 'sticky',
                        left: 0,
                        zIndex: 10,
