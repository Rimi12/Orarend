...
*   **Kréta-kompatibilis Export (Teljes és Tanáronkénti):** Az elkészült órarend exportálható a Kréta rendszer által elvárt formátumban mind egyben (`kréta_import_órarend.xlsx`), mind **pedagógusonként egyesével** (`[Tanár_Neve]_kreta_import.xlsx`), vagy **egy kattintással az összes tanárhoz külön fájlba**. A fájlok tartalmazzák a Kréta hivatalos referencia munkalapjait (`Hetirend`, `Nap`, `Osztály`, `Csoport`, `Tantárgy`, `Tanár`, `Helyiség`).
*   **Automatikus Helyi OneDrive Mentés:** Helyi futtatás esetén az export gombokra kattintva az alkalmazás nemcsak a böngészőbe tölti le a fájlokat, hanem automatikusan elmenti a helyi OneDrive `2026/` könyvtárába is.
